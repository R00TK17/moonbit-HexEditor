...
Write-Host "`$ moon run --target native cmd/main -- struct testfile/test.png" -ForegroundColor Gray
moon run --target native cmd/main -- struct testfile/test.png 2>&1 | Select-Object -First 20
Write-Host ""

Write-Host "--- 2. Signature Scan (Steganography Detection) ---" -ForegroundColor Yellow
Write-Host "`$ moon run --target native cmd/main -- scan testfile/hidden.jpg" -ForegroundColor Gray
moon run --target native cmd/main -- scan testfile/hidden.jpg 2>&1
Write-Host ""

Write-Host "--- 3. Hex Dump ---" -ForegroundColor Yellow
Write-Host "`$ moon run --target native cmd/main -- view testfile/test.txt" -ForegroundColor Gray
moon run --target native cmd/main -- view testfile/test.txt 2>&1
Write-Host ""

Write-Host "--- 4. Entropy Analysis ---" -ForegroundColor Yellow
Write-Host "`$ moon run --target native cmd/main -- entropy testfile/test.zip" -ForegroundColor Gray
moon run --target native cmd/main -- entropy testfile/test.zip 2>&1
Write-Host ""

Write-Host "--- 5. Base64 Encoding ---" -ForegroundColor Yellow
Write-Host "`$ moon run --target native cmd/main -- encode base64 Hello" -ForegroundColor Gray
moon run --target native cmd/main -- encode base64 "Hello" 2>&1
Write-Host ""

Write-Host "--- 6. String Extraction ---" -ForegroundColor Yellow
Write-Host "`$ moon run --target native cmd/main -- strings testfile/test.txt" -ForegroundColor Gray
moon run --target native cmd/main -- strings testfile/test.txt 2>&1
Write-Host ""
...
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "For full TUI: moon run --target native cmd/main -- testfile/test.png" -ForegroundColor White
